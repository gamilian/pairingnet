...
args.add_argument('--emb_dims', type=int, default=1024, metavar='N',
...
args.add_argument('--epoch', type=int, default=800, help='train epoch')
...
args.add_argument('--matching_batch_size', type=int, default=8) #
args.add_argument('--load_checkpoint', type=bool, default=False, help='load checkpoints or not')
args.add_argument('--max_length', type=int, default=2800)
...
args.add_argument('--stage2_epoch', type=int, default=900, help='train epoch')
...
args.add_argument('--infer_set', type=str, default='./{}/ori_dataset_all.pkl'.format(dataset_select), help='searching data path')
